...
#
type
    XPLMGetDatai_f* = proc (inRefcon: pointer): int {.cdecl.}
    XPLMSetDatai_f* = proc (inRefcon: pointer, inValue: int) {.cdecl.}
    ...
    XPLMGetDatavi_f* = proc (inRefcon: pointer, outValues: ptr int, inOffset: int, inMax: int): int {.cdecl.}
    XPLMSetDatavi_f* = proc (inRefcon: pointer, inValues: ptr int, inOffset: int, inCount: int) {.cdecl.}
    XPLMGetDatavf_f* = proc (inRefcon: pointer, outValues: ptr float32, inOffset: int, inMax: int): int {.cdecl.}
    XPLMSetDatavf_f* = proc (inRefcon: pointer, inValues: ptr float32, inOffset: int, inCount: int) {.cdecl.}
    XPLMGetDatab_f* = proc (inRefcon: pointer, outValue: pointer, inOffset: int, inMaxLength: int): int {.cdecl.}
    XPLMSetDatab_f* = proc (inRefcon: pointer, inValue: pointer, inOffset: int, inLength: int) {.cdecl.}
