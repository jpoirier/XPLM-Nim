...
proc XPGetTrackMetrics*(inX1: int,
                        inY1: int,
                        inX2: int,
                        inY2: int,
                        inMin: int,
                        ...
                        outIsVertical: ptr int,
                        outDownBtnSize: ptr int,
